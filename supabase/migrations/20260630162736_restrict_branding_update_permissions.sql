-- Migration: Restrict update_my_company_branding permissions to super_admin and admin roles.
-- Target file: supabase/migrations/20260630162736_restrict_branding_update_permissions.sql
...
BEGIN
  ...
  -- RESTRICCIÓN DE PERMISOS: Solo super_admin y admin

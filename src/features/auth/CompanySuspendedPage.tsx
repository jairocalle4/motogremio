    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gray-50">
      <div className="w-full max-w-md bg-white p-8 rounded-2xl border border-gray-100 shadow-sm text-center">
        ...
        <p className="text-sm text-gray-600 mb-8 leading-relaxed">
          El acceso de tu compañía a la plataforma <strong>{APP_NAME}</strong> ha sido suspendido por falta de pago.
          Por favor, comuníquese con el administrador de la plataforma para reactivar el servicio.
        </p>
